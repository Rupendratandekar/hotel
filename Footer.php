...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Developer:&nbsp;</strong>Rupendra Tandekar, Alok Gour</p>
      <p style="color:white;"><strong>Address:&nbsp;</strong>Vallabh nager, front of marimata mandir, indore</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>hotal@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 7389237589</p><br><br><br>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develope By Rupendra Tandekar And Alok Gour | All Rights Reserved 2021</p>
</footer>
